<template>
  <div class="twoManAnimate">
    <canvas class="illo" ref="canvas" :width="width" :height="height" :style="{'width':width,'height':height}"></canvas>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    var illoElem = this.$refs.canvas;
    var w=illoElem.style,width
    var h=illoElem.style.height
    var zoom =2
